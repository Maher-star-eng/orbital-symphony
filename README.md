...
It is built for people who want to understand why systems become unstable, diverge, resonate, or collapse — not just compute trajectories.
...
## v0.2 — Chaos Visible + Audible
- heatmaps
- stability indicators
- richer sound mappings

## v0.3 — Interactive Instrument
- live controls
- parameter sweeps
